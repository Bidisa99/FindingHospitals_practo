...
public class FindHospitals extends Base {
	...
	/***********************Putting the value on location and type box*****************************/
	...
	/***********************Clicking on the 24*7 Checkbox and Has Parking Checkbox and displaying the Hospital names*****************************/
				...
				for (int p = 1; p <= pages; p++) {
					...
					for (int i = 0; i < ratings.size(); i++) {
						...
						if (rate > 3.5) {
							...
							//test2.log(LogStatus.PASS, ratings.get(i).getText() + " - "+ hnames.get(i).getText());
						}
					}
	...
	/***********************Clicking on the Diagnostic and Fetching the Top Cities name*****************************/
	...
	/***********************Going to the Corporate Wellness page*****************************/
	public void clickCorporateWellness() throws Exception {
		try {
				
				test4 = rep1.startTest("Corporate Wellness");
				//clicking on for providers dropdown
	...
	/***********************Filling the data and submitting the page*****************************/
